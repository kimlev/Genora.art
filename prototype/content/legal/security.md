...
3.4. Основная база данных приложения работает в отдельном контейнере PostgreSQL на европейском сервере приложения и не опубликована напрямую в открытой сети. Конфигурации разработки и рабочей среды используют разные базы. Защита сети, почта и AI-сервисы относятся к отдельным контурам обработки; их местонахождение может отличаться.
...
3.6. Создание резервных копий, их местонахождение, правила доступа, срок хранения и проверки восстановления зависят от действующей конфигурации сервера. Этот документ не утверждает частоту создания или срок удаления копий, пока они не проверены. Доступ к имеющимся копиям должен быть ограничен уполномоченными лицами.
