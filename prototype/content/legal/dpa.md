...
**Непрерывность:** существующие копии dev-базы находятся на VPS HOSTKEY в Хельсинки с доступом только для администратора. Суточное расписание приостановлено до проверки отдельного зашифрованного объектного хранилища в Нидерландах; автоматическая 30-дневная ротация пока не действует. Режим будущей рабочей среды подтверждается отдельно.
