...
- Audio: Highway traffic hum, rushing air drafts, and ambient urban road rumble; no intelligible speech.`,
  ...
  },
  {
    ...
    systemPrompt: "Treat the uploaded full-body photo as the exact first frame and immutable visual source for every frame that follows. Keep its person, identity, face, apparent age, body proportions, clothing, footwear, accessories, background, lighting, colors, objects, camera framing, and composition unchanged. Use any uploaded dance or motion video only as a movement reference: transfer its movement, timing, gestures, and pose changes onto the person in the photo, regardless of who is dancing or where the reference was filmed. Change only the photographed person's movement; never replace, restyle, regenerate, or alter the photo's person, background, clothes, lighting, or framing. Do not copy the reference performer's identity, face, clothes, scene, or objects. Keep motion natural and anatomically plausible for the person shown. If the photo shows a child, keep the dance and presentation strictly age-appropriate and non-sexual. Do not add text, logos, or extra people.",
    icon: "music",
  },
  {
    id: "code-review",
