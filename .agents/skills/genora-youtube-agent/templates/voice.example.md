...
Copy this to a private file under `GENORA_YOUTUBE_STATE_DIR` (for example
`~/.cache/genora-youtube-agent/voice.md`) and fill it in. Every Genora YouTube skill reads it. Ten
